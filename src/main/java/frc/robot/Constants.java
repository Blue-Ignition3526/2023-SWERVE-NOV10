...
public final class Constants {
  ...
  public final static class Swerve {
    ...
    public final static class Physical {
        ...
        public static final Translation2d m_frontLeftLocation = new Translation2d(kTrackWidth/2, kTrackWidth/2); // Front Left Wheel Location
        public static final Translation2d m_frontRightLocation = new Translation2d(kTrackWidth/2, -kTrackWidth/2); // Front Right Wheel Location
        public static final Translation2d m_backLeftLocation = new Translation2d(-kTrackWidth/2, kTrackWidth/2); // Back Left Wheel Location
        public static final Translation2d m_backRightLocation = new Translation2d(-kTrackWidth/2, -kTrackWidth/2); // Back Right Wheel Location
